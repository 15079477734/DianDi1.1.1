 ...
 * <p>
 * Usage: <br>
 * * Create a new instance of this class providing the {@link android.widget.BaseAdapter} to wrap, the undo layout, the undo button id and a {@link DeleteItemCallback}, optionally a delay time millis,
...
public class ContextualUndoAdapter extends BaseAdapterDecorator implements ContextualUndoListViewTouchListener.Callback {
     ...
     * @param deleteItemCallback The {@link DeleteItemCallback} which is called when an item should be deleted from your collection.
     * @param countDownFormatter The {@link CountDownFormatter} which provides text to be shown in the {@link android.widget.TextView} as specified by countDownTextViewResId
     */
