 ...
 */
package com.bmob.im.demo.view.listviewanimations;
...
import com.bmob.im.demo.view.listviewanimations.itemmanipulation.AnimateAdditionAdapter;
import com.bmob.im.demo.view.listviewanimations.widget.DynamicListView;

/**
 * A {@code true} {@link java.util.ArrayList} adapter providing access to all ArrayList methods.
 * Also implements {@link com.bmob.im.demo.view.listviewanimations.widget.DynamicListView.Swappable} for easy object swapping, and {@link com.bmob.im.demo.view.listviewanimations.itemmanipulation.AnimateAdditionAdapter.Insertable} for inserting objects.
 */
...
public abstract class ArrayAdapter<T> extends BaseAdapter implements List<T>, DynamicListView.Swappable, AnimateAdditionAdapter.Insertable<T> {
    ...
    /**
     * Creates a new {@link com.bmob.im.demo.view.listviewanimations.ArrayAdapter} using given {@code List} , or an empty {@code List}  if objects == null.
     */
    ...
    /**
     * Creates a new {@link com.bmob.im.demo.view.listviewanimations.ArrayAdapter}, using (a copy of) given {@code List} , or an empty {@code List}  if objects = null.
