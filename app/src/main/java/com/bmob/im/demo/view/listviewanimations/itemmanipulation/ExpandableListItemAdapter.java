...
import com.bmob.im.demo.view.listviewanimations.ListViewSetter;
import com.bmob.im.demo.view.listviewanimations.util.AdapterViewUtil;

/**
 * An {@link com.bmob.im.demo.view.listviewanimations.ArrayAdapter} which allows items to be expanded using an animation.
 */
...
public abstract class ExpandableListItemAdapter<T> extends ArrayAdapter<T> implements ListViewSetter {
    ...
    /**
     * Creates a new {@link com.bmob.im.demo.view.listviewanimations.itemmanipulation.ExpandableListItemAdapter} with the specified list,
